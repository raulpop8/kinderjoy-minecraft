export default function Footer() {
  return (
    <footer className="border-t-2 border-mc-border mt-16 px-4 sm:px-6 py-5 flex items-center justify-between relative">
      {/* Left: name + heart + ko-fi + year */}
      <div className="flex items-center gap-2 font-pixel text-[7px] text-mc-muted">
        <span>Made by</span>
        <a
          href="https://raulpop.ro"
          target="_blank"
          rel="noopener noreferrer"
          className="text-mc-green-lit hover:text-mc-green transition-colors"
        >
          Raul Pop
        </a>
        <span className="text-mc-red">♥</span>
        <a
          href="https://ko-fi.com/raulpop"
          target="_blank"
          rel="noopener noreferrer"
      ...
      {/* Right: GitHub icon — subtle, tucked in the corner */}
      <a
        href="https://github.com/raulpop8/kinderjoy-minecraft"
        target="_blank"
        rel="noopener noreferrer"
